table 50100 "DocuSign Setup"
{
    ...
    fields
    {
        ...
        field(2; "Client ID"; Text[100]) { Caption = 'Client ID'; }
        field(3; "Client Secret"; Text[100]) { Caption = 'Client Secret'; }
        field(4; "Account ID"; Text[50])
        {
            Caption = 'Account ID';
        }
        ...
        field(6; "Redirect URI"; Text[200]) { Caption = 'Redirect URI'; }
